...
?>
<?php
    // Obtém o ID da página "this" pelo seu título
    $this_page = get_page_by_title('Ministério Regenere');
    $logo_sponsor = get_template_directory_uri() . '/assets/images/sponsor/project-logo.png';
    ...
    if ($this_page) {
        ...
        $this_content = apply_filters('the_content', $this_page->post_content);
    } else {
        $this_content = 'Página não encontrada.';
    }
?>

        <!-- start banner section -->
        <section class="p-0 one-fifth-screen sm-h-450px xs-h-350px cover-background d-flex align-items-end" style="background-image: url('<?php echo esc_url($logo_sponsor); ?>');">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-6 text-center">
                        <img src="<?php echo esc_url($page_02_img1); ?>" alt="" class="w-25">
